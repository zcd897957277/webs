    ...
    callback:    function () {
		...
		function splitData(rawData) {
		    ...
		    for (var i = 0; i < rawData.length; i++) {
		        categoryData.push(rawData[i].splice(0, 1)[0]);//splice从0位开始截取一个数据，并且在原数组中将改数据删除，返回的是删除的部分
		...
		option = {
		    ...
		    tooltip: {
		    	//出发类型，有坐标
		        trigger: 'axis',
		        //tooltip.axisPointer 是配置坐标轴指示器的快捷方式。坐标轴指示器是指示坐标轴当前刻度的工具。
		        axisPointer: {
		        	//'line' 直线指示器
		            type: 'line'
		        }
		    ...
		    xAxis: {
		        ...
		        boundaryGap : false,
		        //坐标轴轴线相关设置。onZero:X 轴或者 Y 轴的轴线是否在另一个轴的 0 刻度上，只有在另一个轴为数值轴且包含 0 刻度时有效。
