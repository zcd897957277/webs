$(document).ready(function() {
  ...
  var settings =
    ...
    '<h4 class="modal-title">改变模板背景</h4>' +
    "</div>" +
  ...
  (function() {
    ...
    // spinner-control 二级菜单
    $(".side-menu>li.two-level-menu").click(function(e) {
      if ($("#sidebar>ul.spinner-control").attr("style")) {
        $("#sidebar>ul.spinner-control").attr("style", "");
      } else {
        $("#sidebar>ul.spinner-control").attr("style", "display:none");
      }
    });
  })();
