      ...
      if ($('.accordion').length && jQuery()) {
        ...
        function initAccordion() {
            jQuery('.accordion-item').each(function (i) {
                ...
                $('.accordion').on("click",".accordion-switch",function () {
                    var displ = jQuery(this).parent().find('.accordion-content').css('display');
                    $('.accordion').find('.accordion-switch').each(function () {
